...
Land generic device capture in psxport with permanent positive and negative CLI tests, then rebuild
CTR against that exact commit. Re-run the initializer 37/37 plus forced 36/37 gate and the zero-fill
41/41 plus forced 40/41 gate before restoring either claim or advancing the product frontier. Do not
pin CTR to a commit that cannot reproduce those checks.
